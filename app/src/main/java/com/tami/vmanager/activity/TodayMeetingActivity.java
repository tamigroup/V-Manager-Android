...
public class TodayMeetingActivity extends BaseActivity {
    ...
    public void initData() {
        ...
        commonAdapter = new CommonAdapter<AllMeetingsResponse.Item.ElementElements>(getApplicationContext(), R.layout.item_meeting, listData) {
            @Override
    ...
    private void query() {
        ...
        allMeetingsRequest.setRequestUrl(HttpKey.TODAY_MEETINGS);
