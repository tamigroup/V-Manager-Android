package com.tami.vmanager.view.RatingBar;
...
public class BaseRatingBar extends LinearLayout implements SimpleRatingBar {
    ...
    private void verifyParamsValue() {
        ...
        if (mEmptyDrawable == null) {
            mEmptyDrawable = ContextCompat.getDrawable(getContext(), R.mipmap.icon_star_no);
        }

        if (mFilledDrawable == null) {
            mFilledDrawable = ContextCompat.getDrawable(getContext(), R.mipmap.icon_star);
        }
